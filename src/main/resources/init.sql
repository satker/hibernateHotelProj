...
insert into capacities (adults, children)
values (0, 1);
insert into room_types (description, name, cost_night, room_size, capacity_id, hotel_id)
values ('Twin Room', '2 twin beds', 14.3, 19, 2, 1);
insert into room_types (description, name, cost_night, room_size, capacity_id, hotel_id)
values ('Six-Bed Room', '2 twin beds  and  4 bunk beds ', 10.2, 14, 1, 1);
insert into room_types (description, name, cost_night, room_size, capacity_id, hotel_id)
values ('Single Room', '1 twin bed', 15.2, 20, 3, 1);
insert into room_types (description, name, cost_night, room_size, capacity_id, hotel_id)
values ('Bed in 4-Bed Dormitory Room', '1 bunk bed', 20.1, 23, 4, 1);
...
insert into parameters (parameter)
values ('Heating');
insert into room_type_parameter (parameter_id, room_type_id)
VALUES (1, 1);
insert into room_type_parameter (parameter_id, room_type_id)
VALUES (2, 1);
insert into room_type_parameter (parameter_id, room_type_id)
